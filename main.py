...
import sys, pygame, os, pygame_gui
from pygame.locals import *
from serialization import get_data
...
class MadGunner:
    ...
    def __init__(self):
        ...
        self.manager = pygame_gui.UIManager((Settings.screen_width, Settings.screen_height))
        self.screen = pygame.display.set_mode((Settings.screen_width, Settings.screen_height))

        self.gui = Gui(self.manager, self.screen, self.game_state)
