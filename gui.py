...
class Gui:
    ...
    def __init__(self, manager, screen, game_state):
    ...
    def process_event(self, event):
        if event.type == pygame.USEREVENT:
            if event.user_type == pygame_gui.UI_BUTTON_PRESSED:
                ...
                if is_volume:
                    self.manager.set_window_resolution((Settings.screen_width, Settings.screen_height))
                    self.show_sound_music_screen(True)
    ...
    def show_gameplay(self):
        ...
        self.show_sound_music_screen(False)
    ...
    def show_sound_music_screen(self, visible):
